...
<head>
  ...
  <style>
    ...
    /* ===== PAGE MARGIN (outside) 🔧 ===== */
    @page { size: A5 portrait; margin: 20px; }          /* ← outer margin */

    html, body {
      font-family: 'NotoSansEnglish','HindDevanagari',sans-serif;
      margin:0; padding:0;
      line-height:1.14; font-size:16px;
    }
    * { box-sizing:border-box; }
    p { margin:0 0 2px 0; line-height:1.14; }

    /* ===== INNER PADDING (inside) 🔧 ===== */
    .wrapper { padding: 20px; }                         /* ← inner padding */
    ...
    /* Right block (Invoice Type / Date / Miti) – small lift */
    .firstdiv{ float:right; margin-top:-14px !important; }
    ...
    /* Invoice No / PAN */
    .forbillandpan{ margin-top:-58px !important; line-height:1.14; }
    .invoice-no{ font-size:20px; font-weight:700; letter-spacing:.3px; margin-bottom:2px; }
    ...
    th,td{ border:1px solid #000; padding:2px 5px; height:22px; line-height:1.12; vertical-align:middle; text-align:center; }
    th{ font-weight:700; }
...
<body>
<div class="wrapper"><!-- inner padding box -->
    ...
    <tbody>
      ...
      @if ($allinvoices)
        @foreach($allinvoices as $i)
          ...
          <tr>
            <td colspan="5"><p style="font-size:14px;text-align:left;"># Goods once sold won't be returned</p></td>
