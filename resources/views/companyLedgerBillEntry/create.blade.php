...
@section('content')
<div class="main-content company-create-page company-bill-entry-create-page"> 
        @yield('breadcrumb')
...
<div class="container-fluid company-create-shell">
    <div class="company-page-actions">
            <a href="{{ route('companys.create') }}" class="company-add-btn">
                <span class="me-1"><i class="fas fa-plus"></i></span>
                <b>Add New Company</b>
            </a>
    </div>

<form class="row gx-4 gy-3 company-entry-form" action="{{ route('companybillentry.store') }}" method="post">
    @csrf
