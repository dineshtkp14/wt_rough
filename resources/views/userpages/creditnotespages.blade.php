...
<div class="main-content">
    ...
    <h2 class="text-center mt-3 bg-primary p-3 text-white"> Credit Notes Pages</h2>
    <a href="{{ url()->previous() }}" class="btn btn-primary back-btn"><i class="fa fa-chevron-left"></i> BACK </a>
    <div class="row mt-4">
        <div class="col-md-4 mb-3">
            <a href="{{ route('creditnotes.create') }}" class="btn btn-primary btn-block btn-super-duper-bigger">
                <i class="fa fa-plus-circle"></i> Create Credit Notes
            </a>
        </div>
        <div class="col-md-4 mb-3">
