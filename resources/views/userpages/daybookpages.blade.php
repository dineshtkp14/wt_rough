...
<div class="main-content">
    ...
    <h2 class="text-center mt-3 bg-primary p-3 text-white">DAYBOOK PAGE</h2>
    <a href="{{ url()->previous() }}" class="btn btn-primary back-btn" style="background: purple"><i class="fa fa-chevron-left"></i> BACK </a>
    <div class="row mt-4 justify-content-center"> <!-- Added justify-content-center class here -->
        <div class="col-md-4 mb-3">
            <a href="{{ route('daybooks.create') }}" class="btn btn-primary btn-block btn-super-duper-bigger">
                <i class="fa fa-plus-circle"></i> ADD DAYBOOK
            </a>
        </div>
        <div class="col-md-4 mb-3">
            <a href="{{ route('daybooks.index') }}" class="btn btn-primary btn-block btn-super-duper-bigger">
                <i class="fa fa-list"></i> VIEW DAYBOOK
            </a>
        </div>
    </div>
