...
<div class="main-content">
    ...
    <h2 class="text-center mt-3 bg-primary p-3 text-white">BANKS PAGE</h2>
    ...
    <div class="btn-container">
        <div class="row mt-4">
            <div class="col-md-6 mb-3">
                <a href="{{ route('banks.create') }}" class="btn btn-primary btn-block btn-super-duper-bigger">
                    <i class="fa fa-plus-circle"></i> ADD BANK
                </a>
            </div>
            <div class="col-md-6 mb-3">
                <a href="{{ route('banks.index') }}" class="btn btn-primary btn-block btn-super-duper-bigger">
                    <i class="fa fa-list"></i> VIEW BANKS
                </a>
            </div>
        </div>
    </div>
