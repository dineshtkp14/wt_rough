...
<div class="main-content">
    ...
    <h2 class="text-center mt-3 bg-primary p-3 text-white">INVOICES PAGE</h2>
    <a href="{{ url()->previous() }}" class="btn btn-primary back-btn"><i class="fa fa-chevron-left"></i> BACK </a>
    <div class="row mt-4">

        <div class="col-md-4 mb-3">
            <a href="{{ route('invoice.index') }}" class="btn btn-primary btn-block btn-super-duper-bigger">
                <i class="fa fa-plus-circle"></i> VIEW SALES ITMES TABLE
            </a>
        </div>

        <div class="col-md-4 mb-3">
            <a href="{{ route('companys.index') }}" class="btn btn-primary btn-block btn-super-duper-bigger">
                <i class="fa fa-list"></i> VIEW INVOICE TABLE
            </a>
        </div>


        <div class="col-md-4 mb-3">
            <a href="{{ route('deletedcustomer.deletebillno') }}" class="btn btn-primary btn-block btn-super-duper-bigger">
                <i class="fa fa-file"></i> SEARCH DELETED INVOCE
            </a>
        </div>
    ...
    <div class="row mt-4">
        <div class="col-md-4 mb-3">
            <a href="{{ route('deleted.invoice') }}" class="btn btn-primary btn-block btn-super-duper-bigger">
                <i class="fa fa-book"></i> VIEW DELETE INVOICE TABLE
            </a>
        </div>
