...
<div class="main-content"> 
    ...
    <div class="container">
        <form class="row gx-5 gy-3" action="{{ route('chequedeposit.update', $chequedepoedit->id) }}" method="post">
            @csrf
            @method('PUT')
            ...
            <div class="col-md-3">
                <div>
                    ...
                    <input type="date" class="form-control @error('date') is-invalid @enderror" 
                        name="date" value="{{ old('date', $chequedepoedit->date) }}" id="date" placeholder="YYYY-MM-DD">
                    @error('date')
            ...
            <!-- You can add the search customer input here if needed -->
            ...
            <div class="col-md-12">
                ...
                <textarea type="text" class="form-control" 
                    name="notes" id="notes" placeholder="Notes">{{ old('notes', $chequedepoedit->notes) }}</textarea>
            </div>

            <!-- Submit Button -->
            <div class="d-grid gap-2 pt-2 pb-4">
                <button type="submit" id="submitBtn" class="btn btn-lg btn-primary">Update</button>
            </div>
        </form>
    </div>
</div>
